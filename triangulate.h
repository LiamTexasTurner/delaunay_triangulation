...
int delauney_triangulate(int *ntris, 
                         std::span<delauney_tri> tris, 
                         int npoints, 
                         std::span<delauney_point> points)
{
      ...
      qsort(&points, npoints, sizeof(delauney_point), delauney_sort);
      ...
      std::vector<bool> complete(trimax);
      std::vector<delauney_edge> edges(100);
